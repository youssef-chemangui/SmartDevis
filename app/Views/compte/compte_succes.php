<main class="form-card-wrapper">
    <div class="form-card" style="max-width:480px; text-align:center; margin: 40px auto;">
        ...
        <div class="form-card__body">
            ...
            ">
                ...
                <div>
                    <p style="font-size:11px; font-weight:500; letter-spacing:.08em; text-transform:uppercase; color:#aaa; margin-bottom:3px;"><?= htmlspecialchars($le_message ?? 'Total comptes') ?></p>
                    <p style="font-size:16px; font-weight:500; color:#1a1a1a;"><?= htmlspecialchars($le_total->total ?? '0') ?> comptes</p>
                </div>
            </div>

            <a href="<?= base_url('index.php/compte/connecter') ?>" class="btn-submit" style="text-decoration:none; display:inline-block;">
                Se connecter
